...
export default function PropertyDetailPage({
  ...
  const monthlyYield =
    (investmentAmount * property.yieldPercent) / 100 / 12;

  return (
    <div className="min-h-screen bg-[#0a0e1a]">
      {/* Hero Section */}
      <div
        className={`h-96 bg-gradient-to-br ${property.imageGradient} relative overflow-hidden`}
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-[#111827]/80 rounded-2xl border border-white/[0.06] shadow-2xl overflow-hidden">
              ...
              <div className="flex border-b border-white/[0.06] overflow-x-auto">
                {['overview', 'financials', 'documents', 'on-chain'].map(
                  (tab) => (
                    <button
                      key={tab}
              ...
              <div className="p-8">
                ...
                {activeTab === 'documents' && (
                  <div className="space-y-3">
                    {[
                      { name: 'Title Deed', icon: 'description' },
                      { name: 'Inspection Report', icon: 'assignment_turned_in' },
                      { name: 'Valuation Report', icon: 'assessment' },
                      { name: 'Financial Statements', icon: 'receipt_long' },
                      { name: 'Legal Documentation', icon: 'gavel' },
                    ].map((doc, i) => (
                      <div
                        key={i}
            ...
            <div className="bg-[#111827]/80 rounded-2xl border border-white/[0.06] shadow-2xl p-8 mt-8">
              ...
              <p className="text-white/70 mb-6">
                This property is tokenized into 2,000,000 ERC-20 tokens,
                allowing fractional ownership. Each token represents an equal
                claim on property income and appreciation. Tokens can be traded
                on the DUAL platform or secondary markets.
              </p>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-[#111827]/80 rounded-2xl border border-white/[0.06] shadow-2xl p-8 space-y-6">
              ...
              <div className="pb-6 border-b border-white/[0.06]">
                ...
                <div className="h-2 bg-white/[0.08] rounded-full overflow-hidden mb-2">
                  <div
                    ...
                    style={{ width: `${100 - property.fundedPercent}%` }}
                  />
                </div>
              ...
              {/* Invest Button */}
              <button className="w-full py-4 bg-gradient-to-r from-[#c9a84c] to-[#a68832] text-[#0a0e1a] font-semibold rounded-lg hover:shadow-lg hover:shadow-[#c9a84c]/30 transition-all duration-300 transform hover:scale-105">
                Invest Now
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-[#111827]/80 rounded-2xl border border-white/[0.06] shadow-2xl p-8">
          ...
          <div className="grid grid-cols-12 gap-1 items-end h-48">
            {[
              45, 52, 48, 61, 58, 72, 65, 78, 85, 92, 88, 95,
            ].map((height, i) => (
              <div
                key={i}
